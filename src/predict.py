...
class ChurnPredictor:
    ...
    def preprocess_customer(self, customer_dict):
        ...
        # Load processed data to get feature engineering logic
        df_processed = pd.read_csv('data/processed/processed_churn_data.csv', nrows=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--high-risk', action='store_true', help='Find all high-risk customers (>70% churn prob)')
    ...
    if args.customer:
        ...
        # Find high-risk customers (demo functionality)
